export const DSL_TOOLS = [
  ...
  },
  {
    ...
    function: {
      ...
      description: "List all available microsites. Returns id, name, slug, and page count for each.",
  ...
  },
  {
    ...
    function: {
      name: "get_page_dsl",
      description: "Fetch the current DSL for a specific page. Use to refresh after a patch.",
      parameters: {
        type: "object",
        properties: {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          preview_hint: {
            type: "string",
            description: "What the user will visually see change in the renderer"
          },
          affected_components: {
            type: "array",
            items: { type: "string" },
        ...
        required: ["microsite_id", "page_path", "patch", "description", "preview_hint", "affected_components"]
      }
    }
  },
  {
    ...
    function: {
      ...
      description: "Get the last N DSL snapshots for a page. Use to understand recent changes or to prepare a rollback.",
      parameters: {
        type: "object",
        properties: {
          microsite_id: { type: "string" },
          page_path: { type: "string" },
          limit: { type: "number", description: "Max snapshots to return, default 3, max 3" }
        },
        required: ["microsite_id", "page_path"]
      }
    }
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          steps_back: {
            type: "number",
            description: "How many operations back to revert. 1 = last change, max 3."
          },
          reason: { type: "string" }
        },
  ...
  },
  {
    ...
    function: {
      ...
      description: "Store a user preference learned from this conversation for future sessions.",
      parameters: {
        type: "object",
        properties: {
